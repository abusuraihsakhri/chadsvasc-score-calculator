"""
Automated Pytest for chadsvasc-score-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    AnticoagulationDecisionSupportWithTimeintherapeuticrangeAnalyticsEngine,
    ClinicalRationaleEngine,
    ImplementationPlanEngine,
    FilesToCreatemodifyEngine,
    AcceptanceCriteriaEngine,
    Continuous12leadEcgWaveformStreamingWithAfBurdenQuantificationEngine,
    ClinicalRationaleEngine,
    ImplementationPlanEngine,
    ChadsvascscorecalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = ChadsvascscorecalculatorEnrichmentSuite()
